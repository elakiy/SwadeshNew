...
/**
 * Created by Elakiya on 5/29/2018.
 */
...
public class Service extends ListActivity implements ServiceConnection {
    ...
    public void onServiceConnected(ComponentName name, IBinder binder) {
        ...
        s = b.getService();
        Toast.makeText(Service.this, "Connected", Toast.LENGTH_SHORT).show();
    }
